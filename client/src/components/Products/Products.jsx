  ...
  return (
    ...
    <Inner title=" Our Products" current="Products"/>
      <div className="main-container  overflow-hidden ">
        <h3 className='heading text-light text-center py-3'>Purchase products from here</h3>
        <p className='quote text-center text-light'>"The farmer is the only man in our economy who buys everything at retail, sells everything at wholesale, and pays the freight both ways.".</p>
