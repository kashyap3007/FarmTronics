  ...
  return (
    ...
    <div className="hero-container">
      ...
      <Loading/>
        ...
        <p className='text-light w-50 m-auto my-5' >Author: {articleData.Author}</p>
        <p className='text-light w-50 m-auto my-3'>Published Data:- {articleData.year.slice(0,10)} </p>
      </>)}
    </div>
      {/* <Footer/> */}
    </>
