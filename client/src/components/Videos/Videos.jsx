...
export const Videos = () => {
  ...
  return (
    ...
    <Inner title="Our Vidoes" current="Vidoes"/>
        ...
        <h3 className=' heading text-light text-center pt-2 '>Follow this tutorial for get more yields.</h3>
        <p className='quote text-center text-light pb-2'>"Agriculture is our wisest pursuit, because it will in the end contribute most to real wealth, good morals & happiness."</p>
